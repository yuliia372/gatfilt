...
<body>
    ...
    <div class="kitten kitten-1">
        <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            <path d="M32 0C19.64 0 9.6 10.04 9.6 22.4v16C9.6 55.12 19.64 64 32 64s22.4-8.88 22.4-25.6v-16C54.4 10.04 44.36 0 32 0zm0 57.6c-9.68 0-16.8-8.8-16.8-19.2v-16C15.2 12.32 21.52 6 32 6c10.48 0 16.8 6.32 16.8 16.8v16c0 10.4-7.12 19.2-16.8 19.2z"/>
        </svg>
    </div>
